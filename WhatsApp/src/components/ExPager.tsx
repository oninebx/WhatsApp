...
> {
  ...
  private gestureHandlerRef: React.RefObject<PanGestureHandler> = React.createRef();
            ...
            if (isSwiping === TRUE) {
              ...
              if (keyboardDismissMode === 'auto') {
                ...
                TextInput.State.blurTextInput(
                  input as React.Component<unknown, {}, any> &
                    Readonly<NativeMethods>,
                );

                // Store the id of this input so we can refocus it if gesture was cancelled
                this.previouslyFocusedTextInput = input as number;
                ...
                if (indexAtSwipeEnd === currentIndex) {
                  ...
                  if (input) {
                    TextInput.State.focusTextInput(
                      (input as unknown) as React.Component<unknown, {}, any> &
                        Readonly<NativeMethods>,
                    );
                  }
                }
